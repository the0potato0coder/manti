...
// This component is intentionally kept for future reuse.
// The route wrapper currently returns notFound() to keep /upcoming-projects hidden
// until product/marketing decides to relaunch this section.
